...
namespace Shared.Tests.PoolingTests {
    public class PoolingTests {
        ...
        public IEnumerator SmokeTest() {
            Assert.IsNull(Pooler.Request("someTag"));
            var instance = Object.FindObjectOfType<Pooler>();
        ...
        public IEnumerator SceneAwakeTest() {
            ...
            Assert.IsNotNull(Pooler.Request("testTag"));
        ...
        public IEnumerator MultipleScenes() {
            ...
            var request = Pooler.Request("testTag");
            Assert.AreEqual(instance.transform.childCount, 100);
            ...
            Pooler.Return("testTag", request);
            Assert.AreEqual(instance.transform.childCount, 100);
            yield return null;

            SceneManager.LoadScene("PoolingTestScene2");
            instance = Object.FindObjectOfType<Pooler>();
        ...
        public IEnumerator StartFromTestWithSingletonAndReturnBack() {
            ...
            var instance1 = Object.FindObjectOfType<Pooler>();
            Assert.IsNotNull(instance1);

            SceneManager.LoadScene("PoolingTestScene2");
            yield return new WaitForSeconds(.1f);

            var instance2 = Object.FindObjectOfType<Pooler>();
            ...
            var instance3 = Object.FindObjectOfType<Pooler>();
